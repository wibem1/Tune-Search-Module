const CACHE='tune-search-v0.4.0';
const CORE=['./?v=0.3.5','./index.html?v=0.3.5','./src/test-app.js?v=0.3.5','./src/tune-search.js?v=0.3.0','./src/providers/thesession.js?v=0.2.0','./src/providers/gavin-heneghan.js?v=0.3.0','./src/providers/mutopia.js?v=0.4.0'];
